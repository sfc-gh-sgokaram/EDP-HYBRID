...
-- Modify the defintion from previous to set the PRIMARY KEY 
create or replace HYBRID TABLE ETL_PIPELINE_RUN_HISTORY_LOG (
PIPELINE_RUN_ID NUMBER(38, 0) NOT NULL PRIMARY KEY, 
PIPELINE_ID NUMBER(38,0) NOT NULL, 
DOMAIN_ID NUMBER (38,0) NOT NULL, 
PROVIDER_SOURCE_ID NUMBER (38,0) NOT NULL, 
ORCHESTRATION_PIPELINE_NM VARCHAR (250),
ORCHESTRATION_PIPELINE_RUN_CD VARCHAR (250) ,
PIPELINE_START_DT TIMESTAMP_NTZ(9), 
PIPELINE_END_DT TIMESTAMP_NTZ(9), 
PIPELINE_RUN_STATUS VARCHAR (80) ,
